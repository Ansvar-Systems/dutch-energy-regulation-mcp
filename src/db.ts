/**
 * SQLite database access layer for the Dutch Energy Regulation MCP server.
 *
 * Schema covers four Dutch energy regulators:
 *   - regulations      — ACM method decisions, RVO subsidy rules, SodM safety regulations
 *   - grid_codes       — TenneT NL grid codes, netcodes, congestion management
 *   - decisions        — ACM tariff determinations, market monitoring reports
 *
